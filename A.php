...
//this part gathers all the configuration parametres that are necessary for the process
echo "starting up
";
...
<meta itemscope itemtype="https://schema.org/CreativeWork" itemprop="license" content ="$domain/terms.html"/>
...
/*Copyright $year $author, shared under my Terms of use and copyright $domain/terms.html , which serve as the license of this template too.*/
.flex-container > * {
    padding: 6px;
    flex: 100%;
}
...
<body class="body">
  ...
  <footer class="footer"><div class="flex-container3"><div class="copyright">Copyright $author $year</div><div class="terms"><a href="terms.html">Terms of use and copyright statement</a></div><div class="contact"><a href="contact.html">Contact</a></div><div class="contact"><a href="about.html">About</a></div></div></footer>
...
<div class="info title" style="padding:3%">R1TITLE</div>
  ...
  <article class="article"><!-- Copyright $author $year, shared under my Terms of use $domain/terms.html , serving as the license for this content's publication.-->SCHEMAMETA2
HEADER;
